  ...
  async create(
    ...
    try {
      ...
      const response = await this.service.getResponse({
        code: 201,
        value: value,
        message: 'Create message was successful',
      });
  ...
  async findAll(@Req() req, @Res() res, @Next() next: NextFunction) {
    try {
      ...
      const response = await this.service.getResponse({
        code: 200,
        value: value,
        message: 'Find all messages was successful',
      });
  ...
  async findOne(
    ...
    try {
      ...
      const response = await this.service.getResponse({
        code: 200,
        value: value,
        message: 'Find message was successful',
      });
      return res.status(200).json(response);
    } catch (error) {
      next(error);
  ...
  async update(
    ...
    try {
      ...
      const response = await this.service.getResponse({
        code: 200,
        value: value,
        message: 'Update message was successful',
      });
      return res.status(200).json(response);
    } catch (error) {
      next(error);
  ...
  async remove(
    ...
    try {
      ...
      const response = await this.service.getResponse({
        code: 200,
        value: value,
        message: 'Remove message was successful',
      });
      return res.status(200).json(response);
    } catch (error) {
      next(error);
